...
// Bordó theme colors
val BordoPrimary = Color(0xFFE53935)
val BordoSecondary = Color(0xFF880E4F)
val BordoTertiary = Color(0xFFD81B60)
val BordoBackground = Color(0xFF0D0508)
val BordoSurface = Color(0xFF160A0E)
val BordoSurfaceVariant = Color(0xFF2A1018)
val BordoCard = Color(0xFF1E0D13)
val BordoBorder = Color(0xFF4A1020)
val BordoDivider = Color(0xFFB71C1C)
val TextBordoSecondary = Color(0xFFB08090)

// Void theme colors
val VoidPrimary = Color(0xFF00E5CC)
val VoidSecondary = Color(0xFF006D5B)
val VoidTertiary = Color(0xFF80FFE8)
val VoidBackground = Color(0xFF020808)
val VoidSurface = Color(0xFF050F0E)
val VoidSurfaceVariant = Color(0xFF0A1F1C)
val VoidCard = Color(0xFF071816)
val VoidBorder = Color(0xFF0D3330)
val VoidDivider = Color(0xFF00897B)
val TextVoidSecondary = Color(0xFF6BBFB5)